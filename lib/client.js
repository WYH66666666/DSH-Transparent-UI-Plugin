window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		//#region \0dsh-css:/home/vikna/deepseek-harness/packages/client/ui-aqua/src/client/AquaPluginCard.module.css.mjs
		const css$3 = ".xhd07G_card{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-1);border-radius:12px;flex-direction:column;padding:16px;display:flex}.xhd07G_head{justify-content:space-between;align-items:center;gap:16px;display:flex}.xhd07G_text{flex-direction:column;gap:2px;min-width:0;display:flex}.xhd07G_title{color:var(--dsw-alias-label-primary);font-size:14px;font-weight:500;line-height:22px}.xhd07G_description{color:var(--dsw-alias-label-tertiary);font-size:12px;line-height:18px}.xhd07G_toggle{border:1px solid var(--dsw-alias-border-l2);height:28px;color:var(--dsw-alias-label-primary);cursor:pointer;background:0 0;border-radius:14px;flex:none;align-items:center;gap:6px;padding:0 10px 0 6px;font-size:12px;line-height:18px;display:inline-flex}.xhd07G_toggle:hover{background:var(--dsw-alias-interactive-bg-hover)}.xhd07G_toggle[aria-pressed=true]{background:var(--dsw-alias-state-business-tertiary);color:var(--dsw-alias-state-business-primary);border-color:#0000}.xhd07G_check{justify-content:center;align-items:center;width:16px;height:16px;display:inline-flex}";
		...
		var AquaPluginCard_module_css_default = {
			"head": "xhd07G_head",
			"description": "xhd07G_description",
			"check": "xhd07G_check",
			"card": "xhd07G_card",
			"title": "xhd07G_title",
			"text": "xhd07G_text",
			"toggle": "xhd07G_toggle"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/home/vikna/deepseek-harness/packages/client/ui-aqua/src/client/AquaAppearanceRow.module.css.mjs
		const css$2 = ".U_zdBa_group{border-bottom:1px solid var(--dsw-alias-border-l2);flex-direction:column;gap:14px;padding:8px 0 16px;display:flex}.U_zdBa_subGroup{flex-direction:column;gap:8px;display:flex}.U_zdBa_subTitle{color:var(--dsw-alias-label-primary);font-size:13px;font-weight:600;line-height:20px}.U_zdBa_controls{flex-direction:column;gap:10px;display:flex}.U_zdBa_row{align-items:center;gap:10px;display:flex}.U_zdBa_rowLabel{width:92px;color:var(--dsw-alias-label-secondary);flex:none;font-size:12px;line-height:18px}.U_zdBa_inlineLabel{color:var(--dsw-alias-label-secondary);flex:none;font-size:12px;line-height:18px}.U_zdBa_rowHint{color:var(--dsw-alias-label-tertiary);margin-top:-4px;margin-left:102px;font-size:12px;line-height:18px}.U_zdBa_groupHint{color:var(--dsw-alias-label-tertiary);margin-top:-4px;font-size:12px;line-height:18px}.U_zdBa_knobHint{color:var(--dsw-alias-label-tertiary);margin-top:-4px;margin-left:102px;font-size:12px;line-height:18px}.U_zdBa_toggle,.U_zdBa_toggleOn{border:1px solid var(--dsw-alias-border-l2);height:28px;color:var(--dsw-alias-label-primary);cursor:pointer;background:0 0;border-radius:14px;align-items:center;gap:6px;padding:0 10px 0 6px;font-size:12px;line-height:18px;display:inline-flex}.U_zdBa_toggle:hover{background:var(--dsw-alias-interactive-bg-hover)}.U_zdBa_toggleOn{background:var(--dsw-alias-state-business-tertiary);color:var(--dsw-alias-state-business-primary);border-color:#0000}.U_zdBa_check{justify-content:center;align-items:center;width:16px;height:16px;display:inline-flex}.U_zdBa_knob{align-items:center;gap:10px;display:flex}.U_zdBa_knobLabel{width:92px;color:var(--dsw-alias-label-secondary);flex:none;font-size:12px;line-height:18px}.U_zdBa_slider{min-width:0;accent-color:var(--dsw-alias-state-business-primary);flex:1}.U_zdBa_numberWrap{flex:none;align-items:center;gap:4px;display:inline-flex}.U_zdBa_number{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-2);width:56px;height:26px;color:var(--dsw-alias-label-primary);text-align:right;border-radius:8px;padding:0 6px;font-size:12px;line-height:18px}.U_zdBa_number::-webkit-outer-spin-button,.U_zdBa_number::-webkit-inner-spin-button{-webkit-appearance:none;margin:0}.U_zdBa_unit{width:18px;color:var(--dsw-alias-label-tertiary);flex:none;font-size:12px;line-height:18px}.U_zdBa_segmented{border:1px solid var(--dsw-alias-border-l2);border-radius:8px;display:inline-flex;overflow:hidden}.U_zdBa_seg,.U_zdBa_segActive{height:26px;color:var(--dsw-alias-label-secondary);cursor:pointer;background:0 0;border:none;padding:0 12px;font-size:12px;line-height:18px}.U_zdBa_seg+.U_zdBa_seg,.U_zdBa_segActive+.U_zdBa_seg,.U_zdBa_seg+.U_zdBa_segActive{border-left:1px solid var(--dsw-alias-border-l2)}.U_zdBa_segActive{background:var(--dsw-alias-state-business-tertiary);color:var(--dsw-alias-state-business-primary)}.U_zdBa_wallpaperPick{align-items:center;gap:10px;display:flex}.U_zdBa_fileInput{display:none}.U_zdBa_pickButton{border:1px solid var(--dsw-alias-border-l2);height:26px;color:var(--dsw-alias-label-primary);cursor:pointer;background:0 0;border-radius:8px;padding:0 12px;font-size:12px;line-height:18px}.U_zdBa_pickButton:hover{background:var(--dsw-alias-interactive-bg-hover)}.U_zdBa_deleteButton{border:1px solid var(--dsw-alias-border-l2);height:26px;color:var(--dsw-alias-label-error);cursor:pointer;background:0 0;border-radius:8px;padding:0 12px;font-size:12px;line-height:18px}.U_zdBa_deleteButton:hover{background:var(--dsw-alias-interactive-bg-hover)}";
		...
		var AquaAppearanceRow_module_css_default = {
			"knobHint": "U_zdBa_knobHint",
			"check": "U_zdBa_check",
			"knobLabel": "U_zdBa_knobLabel",
			"fileInput": "U_zdBa_fileInput",
			"row": "U_zdBa_row",
			"pickButton": "U_zdBa_pickButton",
			"toggleOn": "U_zdBa_toggleOn",
			"deleteButton": "U_zdBa_deleteButton",
			"toggle": "U_zdBa_toggle",
			"numberWrap": "U_zdBa_numberWrap",
			"groupHint": "U_zdBa_groupHint",
			"knob": "U_zdBa_knob",
			"group": "U_zdBa_group",
			"number": "U_zdBa_number",
			"segmented": "U_zdBa_segmented",
			"rowLabel": "U_zdBa_rowLabel",
			"wallpaperPick": "U_zdBa_wallpaperPick",
			"seg": "U_zdBa_seg",
			"inlineLabel": "U_zdBa_inlineLabel",
			"controls": "U_zdBa_controls",
			"slider": "U_zdBa_slider",
			"subGroup": "U_zdBa_subGroup",
			"unit": "U_zdBa_unit",
			"subTitle": "U_zdBa_subTitle",
			"rowHint": "U_zdBa_rowHint",
			"segActive": "U_zdBa_segActive"
		};
		//#endregion
...
`;
		...
		*/
		...
		const SEAMS = [
			...
			{
				attribute: "data-dsh-aqua-spot",
				selector: "[data-dsh-better-sidebar] > div[class*=\"panel\" i]:not([class*=\"bottomPanel\" i])"
			},
			{
				attribute: "data-dsh-aqua-spot",
				selector: "[data-dsh-better-sidebar] > div[class*=\"bottomPanel\" i]"
			},
			{
...
<path d="M22.9168 1.43018C22.6713 1.31018 22.5658 1.53918 22.4223 1.65519C22.3733 1.69269 22.3318 1.74169 22.2903 1.78669C21.9317 2.1697 21.5127 2.42121 20.9657 2.39121C20.1657 2.34621 19.4827 2.59771 18.8787 3.20973C18.7502 2.45521 18.3236 2.0047 17.6746 1.71569C17.3351 1.56568 16.9916 1.41518 16.7536 1.08867C16.5876 0.856163 16.5421 0.597155 16.4591 0.341647C16.4061 0.187643 16.3536 0.0301382 16.1761 0.00363739C15.9836 -0.0263635 15.9081 0.135141 15.8326 0.270145C15.5306 0.822162 15.4136 1.43018 15.4251 2.0462C15.4516 3.43174 16.0366 4.53527 17.1991 5.3203C17.3311 5.4103 17.3651 5.5003 17.3236 5.63181C17.2441 5.90231 17.1501 6.16482 17.0671 6.43533C17.0141 6.60784 16.9351 6.64584 16.7501 6.57033C16.1121 6.30383 15.5611 5.90931 15.074 5.4328C14.2475 4.63328 13.5 3.75075 12.568 3.05973C12.349 2.89822 12.13 2.74822 11.9034 2.60522C10.9524 1.68169 12.028 0.923165 12.277 0.833162C12.5375 0.739159 12.3675 0.41615 11.5259 0.42015C10.6844 0.42365 9.91439 0.705658 8.93286 1.08117C8.78935 1.13767 8.63835 1.17867 8.48384 1.21267C7.59332 1.04367 6.66829 1.00617 5.70226 1.11517C3.88321 1.31768 2.43016 2.1777 1.36213 3.64575C0.0790928 5.4103 -0.222916 7.41536 0.146595 9.50642C0.535106 11.7105 1.66014 13.535 3.38869 14.9616C5.18125 16.4406 7.24581 17.1657 9.60138 17.0266C11.0319 16.9441 12.6245 16.7526 14.421 15.2321C14.874 15.4576 15.3496 15.5476